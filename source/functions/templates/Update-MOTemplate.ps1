        ...
        foreach($key in $targets){
            ...
            try{
                ...
                if($newSha -eq $entry.sha256){
                    ...
                    #Composite action: copy the expanded dir into <name>/ (parent of action.yml).
                    #Single file: copy to the file path. Either way the dest dir is the parent of the lock path.
